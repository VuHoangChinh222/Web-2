...
const Products = () => {
  const { products, categoriesProduct, addProduct, updateProduct, deleteProduct } = useAdmin();
                ...
                {filteredProducts.map((prod) => (
                  <tr key={prod.id} className="hover:bg-white/[0.01] transition-colors">
                    <td className="py-2.5 pr-2">
                      <img src={prod.image} alt={prod.name} className="w-10 h-7 rounded object-cover border border-white/10" />
                    </td>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-4">
              {currentProduct.image && (
                <img src={currentProduct.image} alt="Preview" className="w-14 h-14 rounded-lg object-cover border border-purple-500/20" />
              )}
