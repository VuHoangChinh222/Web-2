...
const ProductGridCard = ({ prod, categoriesProduct, getStatusBadge, resolveImageUrl, handleOpenView, handleOpenEdit, handleOpenVariants, handleDelete, handleToggleStatus }) => {
  return (
      ...
      <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
        <div>
          <div className="flex items-baseline gap-1.5">
            <span className="text-base font-bold text-white">{prod.salePrice.toLocaleString()} VND</span>
